function C_tw=Moving_Win_TID_Detection(C,time_of_interest,plot_or_not)
...
Plot_Fit_In_TimeWin(C_tw,plot_or_not) %plot arcs and sinefit to evaluate goodness of fit visually
